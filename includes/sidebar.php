<div class="sidebar">
            <div class="sidebar-text d-flex flex-column h-100 justify-content-center text-center">
                <img class="mx-auto d-block w-75 bg-primary img-fluid rounded-circle mb-4 p-3" src="img\mohamed-Amine .jpg" alt="Image">
                <h1 class="font-weight-bold">Mohamed Amine TARHOUNI</h1>
                <p class="mb-4">
                    Un jeune développeur passionné par les jeux vidéos
                </p>
